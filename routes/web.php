...
use App\Http\Controllers\HomeReguestController;
...
Route::get('/home-updated-requests', [HomeReguestController::class, 'updatedHomeRequests'])->name('home-updated-requests');
